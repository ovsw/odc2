...
(0, _jquery2.default)(document).ready(function () {
  ...
  (0, _jquery2.default)('.header__menu-icon').click(function () {
    (0, _jquery2.default)('.top-nav').toggleClass('top-nav__visible');
    (0, _jquery2.default)(this).toggleClass('header__menu-icon--close-x');
  });

  // mobile menu sub-items toggle
  (0, _jquery2.default)('.top-nav__submenu-button').click(function () {
    var menuItem = (0, _jquery2.default)(this).parent();

    if (menuItem.hasClass('`submenu`-open')) {
      (0, _jquery2.default)('.top-nav__has-children').removeClass('submenu-open');
    } else {
      (0, _jquery2.default)('.top-nav__has-children').removeClass('submenu-open');
  ...
  // slideshow
  if ((0, _jquery2.default)('.text-slideshow__slide').length > 1) {
    var hpSlideshow = new _Slideshow2.default('.text-slideshow__slide', 3, 1);
  } else {
    var hpSlideshow = new _Slideshow2.default('.text-slideshow__slide', 3, 1, true);
  }
  ...
  (0, _jquery2.default)('.tabs__button').click(function () {
    var tab_id = (0, _jquery2.default)(this).attr('data-tab');
    (0, _jquery2.default)(this).siblings().removeClass('active');
    (0, _jquery2.default)(this).addClass('active');
    (0, _jquery2.default)(this).parent().next('.tabs__content').children('.tabs__tab').removeClass('active');
    (0, _jquery2.default)('.' + tab_id).addClass('active');
  });

  // show card details
  (0, _jquery2.default)('.with-lightbox').click(function () {
    console.log((0, _jquery2.default)(this).index());
    showOverlay();

    (0, _jquery2.default)('.card-details__wrapper .card-details:eq(' + (0, _jquery2.default)(this).index() + ')').clone(true, true).appendTo('.overlay__content');

    var video_url = (0, _jquery2.default)('.overlay__content .card-details__video').data("videourl");

    var vimeoId = getVimeoId(video_url);

    if (vimeoId != false) {
      (0, _jquery2.default)('.overlay__content .embed-container').html('<iframe src="https://player.vimeo.com/video/' + vimeoId + '?autoplay=0&title=0&byline=0&portrait=0" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>');
    }
  });

  function showOverlay() {
    (0, _jquery2.default)('.overlay').show();
    (0, _jquery2.default)('.footer__wrapper,.large-hero').addClass('hideonMobile');
  }
  function hideOverlay() {
    (0, _jquery2.default)('.overlay').hide();
    (0, _jquery2.default)('.footer__wrapper,.large-hero').removeClass('hideonMobile');
  }
  ...
  // close card details
  (0, _jquery2.default)('.card-details__back-btn').click(function (e) {
    e.preventDefault();
    (0, _jquery2.default)('.overlay__content .card-details').remove();
    hideOverlay();
  });

  // toggle FAQs

  (0, _jquery2.default)('.mx__faqs__answer').hide();
  (0, _jquery2.default)('.mx__faqs__question').click(function () {
    var toggle = (0, _jquery2.default)(this).nextUntil('.mx__faqs__question');
    toggle.slideToggle();
    (0, _jquery2.default)('.mx__faqs__answer').not(toggle).slideUp();
  });
...
var Slideshow = function () {
  function Slideshow(slidesSel) {
    ...
    this.slideEls = (0, _jquery2.default)(slidesSel);
    this.fadeInDur = fadeInDur;
    this.fadeOutDur = fadeOutDur;
    this.masterTl = new _gsap.TimelineMax({ repeat: this.repeat });
  ...
  _createClass(Slideshow, [{
    key: "createSlideTls",
    value: function createSlideTls() {
      var self = this;

      // create a timeline for each slide
      (0, _jquery2.default)(this.slideEls).each(function (i, slideEl) {
        var slideTl = new _gsap.TimelineLite();
    ...
    key: "animateSlide",
    value: function animateSlide(slideEl, slideTl) {
      // complete animation for one slide
      slideTl.to(slideEl, this.fadeInDur, // fade in dur.
      {
        // ease: Bounce.easeOut,
        autoAlpha: 0.8
      }).to(slideEl, this.fadeOutDur, // fade out dur.
      {
        // ease: Bounce.easeOut,
        autoAlpha: 0
    ...
    key: "animateSingleSlide",
    value: function animateSingleSlide(slideEl, slideTl) {
      // complete animation for one slide
      slideTl.to(slideEl, this.fadeInDur, // fade in dur.
      {
        // ease: Bounce.easeOut,
